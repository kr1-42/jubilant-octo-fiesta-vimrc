...
"                                                 +#+#+#+#+#+   +#+            "
"    Created: 2025/12/12 17:15:52 by chrilomb          #+#    #+#              "
"    Updated: 2025/12/12 17:16:01 by chrilomb         ###   ########.fr        "
"                                                                              "
" **************************************************************************** "

" -------------------------------
" STDHEADER.VIM
" Auto-insert 42-style header for new C/C++/PHP/etc. files
" -------------------------------
...
function! s:textline(left, right)
    ...
    return s:start . repeat(' ', s:margin - strlen(s:start)) . l:left
            \ . repeat(' ', s:length - s:margin * 2 - strlen(l:left) - strlen(a:right))
            \ . a:right . repeat(' ', s:margin - strlen(s:end)) . s:end
endfunction
